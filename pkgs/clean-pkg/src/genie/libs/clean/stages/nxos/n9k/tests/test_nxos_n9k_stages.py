...
from genie.libs.clean.stages.nxos.stages import change_boot_variable
...
from genie.libs.clean.stages.nxos.n9k.tests.nxos_n9k_pos_stage_outputs import \
...
from genie.libs.clean.stages.nxos.n9k.tests.nxos_n9k_neg_stage_outputs import \
...
class PositiveStages(unittest.TestCase):
    ...
    @unittest.mock.patch('os.path.getsize', Mock(return_value=1513778688))
    ...
    def test_stage_copy_to_device(self):
        ...
        self.device.api.get_file_size_from_server = Mock(return_value=1513778688)
        self.device.api.verify_file_size_stable_on_server = Mock(return_value=True)
...
class NegativeStages(unittest.TestCase):
    ...
    def test_stage_copy_to_device(self):
        ...
        self.device.api.get_file_size_from_server = Mock(return_value=1513778699)
        self.device.api.verify_file_size_stable_on_server = Mock(return_value=True)
